...
// */
//public class IndividualRecipeFlavorTableModel extends AbstractTableModel {
//	private String[] columns = {"Name", "Description"};
//	private Type[] colType = {String.class, String.class};
//	private Set<Flavor> flavors;
//
//	public IndividualRecipeFlavorTableModel(Recipe recipe) {
//		this.flavors = recipe.getRecipe().keySet();
//	}
//	@Override
